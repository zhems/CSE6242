...
d3.csv("earthquakes.csv", function (d) {
    ...
    svg_a.append("circle").attr("cx",width-120).attr("cy",0).attr("r", 6).style("fill", "#FFC300")
    svg_a.append("circle").attr("cx",width-120).attr("cy",20).attr("r", 6).style("fill", "#FF5733")
    svg_a.append("circle").attr("cx",width-120).attr("cy",40).attr("r", 6).style("fill", "#C70039")
    svg_a.append("circle").attr("cx",width-120).attr("cy",60).attr("r", 6).style("fill", "#900C3F")
    svg_a.append("text").attr("x", width-90).attr("y", 0).text("5_5.9").style("font-size", "15px").attr("alignment-baseline","middle")
    svg_a.append("text").attr("x", width-90).attr("y", 20).text("6_6.9").style("font-size", "15px").attr("alignment-baseline","middle")
    svg_a.append("text").attr("x", width-90).attr("y", 40).text("7_7.9").style("font-size", "15px").attr("alignment-baseline","middle")
    svg_a.append("text").attr("x", width-90).attr("y", 60).text("8.0+").style("font-size", "15px").attr("alignment-baseline","middle")
...
// PART B
    ...
    svg_b.append("circle").attr("cx",width-120).attr("cy",0).attr("r", 6).style("fill", "#FFC300")
    svg_b.append("circle").attr("cx",width-120).attr("cy",20).attr("r", 6).style("fill", "#FF5733")
    svg_b.append("circle").attr("cx",width-120).attr("cy",40).attr("r", 6).style("fill", "#C70039")
    svg_b.append("circle").attr("cx",width-120).attr("cy",60).attr("r", 6).style("fill", "#900C3F")
    svg_b.append("text").attr("x", width-90).attr("y", 0).text("5_5.9").style("font-size", "15px").attr("alignment-baseline","middle")
    svg_b.append("text").attr("x", width-90).attr("y", 20).text("6_6.9").style("font-size", "15px").attr("alignment-baseline","middle")
    svg_b.append("text").attr("x", width-90).attr("y", 40).text("7_7.9").style("font-size", "15px").attr("alignment-baseline","middle")
    svg_b.append("text").attr("x", width-90).attr("y", 60).text("8.0+").style("font-size", "15px").attr("alignment-baseline","middle")
...
// PART C
    ...
    svg_c.append("circle").attr("cx",width-120).attr("cy",0).attr("r", 6).style("fill", "#FFC300")
    svg_c.append("circle").attr("cx",width-120).attr("cy",20).attr("r", 6).style("fill", "#FF5733")
    svg_c.append("circle").attr("cx",width-120).attr("cy",40).attr("r", 6).style("fill", "#C70039")
    svg_c.append("circle").attr("cx",width-120).attr("cy",60).attr("r", 6).style("fill", "#900C3F")
    svg_c.append("text").attr("x", width-90).attr("y", 0).text("5_5.9").style("font-size", "15px").attr("alignment-baseline","middle")
    svg_c.append("text").attr("x", width-90).attr("y", 20).text("6_6.9").style("font-size", "15px").attr("alignment-baseline","middle")
    svg_c.append("text").attr("x", width-90).attr("y", 40).text("7_7.9").style("font-size", "15px").attr("alignment-baseline","middle")
    svg_c.append("text").attr("x", width-90).attr("y", 60).text("8.0+").style("font-size", "15px").attr("alignment-baseline","middle")
...
// PART D
    ...
    svg_d.append("circle").attr("cx",width-120).attr("cy",0).attr("r", 6).style("fill", "#FFC300")
    svg_d.append("circle").attr("cx",width-120).attr("cy",20).attr("r", 6).style("fill", "#FF5733")
    svg_d.append("circle").attr("cx",width-120).attr("cy",40).attr("r", 6).style("fill", "#C70039")
    svg_d.append("circle").attr("cx",width-120).attr("cy",60).attr("r", 6).style("fill", "#900C3F")
    svg_d.append("text").attr("x", width-90).attr("y", 0).text("5_5.9").style("font-size", "15px").attr("alignment-baseline","middle")
    svg_d.append("text").attr("x", width-90).attr("y", 20).text("6_6.9").style("font-size", "15px").attr("alignment-baseline","middle")
    svg_d.append("text").attr("x", width-90).attr("y", 40).text("7_7.9").style("font-size", "15px").attr("alignment-baseline","middle")
    svg_d.append("text").attr("x", width-90).attr("y", 60).text("8.0+").style("font-size", "15px").attr("alignment-baseline","middle")
